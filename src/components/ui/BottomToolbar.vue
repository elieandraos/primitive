    ...
    <div class="absolute bottom-0 w-full flex items-center flex-col">
        <div class="flex justify-between w-1/3 py-4 px-6 text-gray-200 bg-white bg-opacity-70 rounded-xl cursor-pointer">
            ...
            <div class="hover:text-orange-300" :class="{ 'text-orange-300': activeRoute === 'laravel' }" @click="navigate('laravel')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" class="w-8 h-8">
